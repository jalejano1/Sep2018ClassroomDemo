...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Repeater ID="DTORepeater" runat="server" DataSourceID="DTORepeaterODS" ItemType="Chinook.Data.DTOs.AnAlbum">
        <HeaderTemplate>
            <h3>Album Song List</h3>
        </HeaderTemplate>
        <ItemTemplate>
            <h4><%# Item.title %> (<%#Item.artist %>)</h4> <br />
            <asp:Repeater ID="POCORepeater" runat="server" DataSource="<%# Item.songs %>" ItemType="Chinook.Data.POCOs.Songs">
                <ItemTemplate>
