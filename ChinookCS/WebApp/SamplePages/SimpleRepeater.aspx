...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <blockquote>
        ...
        The data is a first dataset described in the POCO 
    </blockquote>
    <uc1:MessageUserControl runat="server" ID="MessageUserControl" />
    <asp:Repeater ID="PlaylistSummaryList" runat="server" DataSourceID="PlaylistSummaryListODS" ItemType="Chinook.Data.POCOs.PlaylistSummary">
        <HeaderTemplate>
