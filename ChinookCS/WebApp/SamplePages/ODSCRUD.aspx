...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <blockquote>
        ...
        <br />
        For a ODSDelete to be successful you <strong><u>MUST</u></strong> include on the 
    ...
    <asp:ListView ID="AlbumList" runat="server" DataSourceID="AlbumListODS" DataKeyNames="AlbumId" InsertItemPosition="LastItem">
        <AlternatingItemTemplate>
            <tr style="background-color: #FFFFFF; color: #284775;">
                ...
                <td>
                    <asp:Label Text='<%# Eval("AlbumId") %>' runat="server" Enabled="false" Width="50px" ID="AlbumIdLabel" /></td>
                <td>
                ...
                <td>
                    <asp:Label Text='<%# Eval("ReleaseYear") %>' runat="server" Width="75px" ID="ReleaseYearLabel" /></td>
                <td>
        ...
        <EditItemTemplate>
            <tr style="background-color: #999999;">
                ...
                <td>
                    <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server" Width="75px" ID="ReleaseYearTextBox" /></td>
                <td>
